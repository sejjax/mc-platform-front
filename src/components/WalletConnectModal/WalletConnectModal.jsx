...
const WalletConnectModal = () => {
  ...
  useEffect(() => {
    if (!defaultWalletAddress && address && isAuth)
      dispatch(editDefaultWalletNumber(address))
  ...
  return (
    ...
    >
      ...
      <div className="p-4 text-center">
        <p className="fs-4">
          У вас не подключен кошелёк по умолчанию, реферальные начисления будут
          недоступны. Пожалуйста, подключите кошелёк
        </p>
