...
export const getPromotionGoalFromLevel = (level) => {
  if (
    ...
    return {
      ...
      withoutStrongest: PROMOTION_LEVEL_TO_GOAL_STRUCTURE_WITHOUT_STRONGEST[level],
    };

  return {
    allStructure: DEFAULT_PROMOTION_LEVEL_TO_GOAL_ALL_STRUCTURE,
    withoutStrongest: DEFAULT_PROMOTION_LEVEL_TO_GOAL_STRUCTURE_WITHOUT_STRONGEST,
  };
};
